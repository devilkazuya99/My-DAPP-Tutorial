...
contract("Election", function (accounts) {
  ...
  it("thrown an exception for invalid candidates", function () {
    return Election.deployed().then(function (instance) {
      electionInstance = instance;
      ...
      assert.equal(voteCount, 0, "candidate 2 did not receive any votest");
    });
  });

  it("thrown an exception for double voting", function () {
    return Election.deployed().then(function (instance) {
      electionInstance = instance;
      candidateId = 2;
      ...
      var voteCount = candidate2[2];
      assert.equal(voteCount, 1, "candidate 2 did not receive any votest");
    });
  });
